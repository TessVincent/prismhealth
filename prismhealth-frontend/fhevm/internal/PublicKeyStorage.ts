...
function assertFhevmStoredPublicKey(
  ...
  if (typeof value !== "object" || !("publicKeyId" in value) || !("publicKey" in value)) {
    throw new Error(`FhevmStoredPublicKey must be an object with publicKeyId and publicKey`);
  }
...
function assertFhevmStoredPublicParams(
  ...
  if (value === null) return;
  if (typeof value !== "object" || !("publicParamsId" in value) || !("publicParams" in value)) {
    throw new Error(`FhevmStoredPublicParams must be an object with publicParamsId and publicParams`);
  }
